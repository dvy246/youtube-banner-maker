...
The `/backgrounds` MPA showcase hub and its 6 localized counterparts (`/[locale]/backgrounds`) provide creators with 160 studio-grade, mathematically centered 2560 × 1440 px aesthetic backgrounds (expanded with Studio Ghibli scenery, anime hero masterworks, cosmic ink deities, and high-fidelity landscape masters):
